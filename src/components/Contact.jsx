const Contact = () => {
  const socialLinks = [
    {
      href: "https://github.com/YashParmar0001",
      icon: (
        <svg
          width="24"
          height="24"
    ...
    {
      href: "https://www.linkedin.com/in/yash-parmar-b34b90220/",
      icon: (
        <svg
          width="24"
          height="24"
  ...
  return (
    <section id="contact" className="section mb-5">
      <div className="container w-full flex flex-col gep-9">
        <div className="w-[50%] flex flex-col gap-5">
          <h2 className="headline-2 w-[400px]">Contact me for collaboration</h2>

          <p className="w-[450px] text-zinc-400">
          ...
          <div className="flex gap-4 mt-[4rem]">
            {socialLinks?.map(({ href, icon }, key) => (
              <a
                ...
                target="_blank"
                key={key}
                className="p-1 border border-gray-100 rounded-lg"
              >
                {icon}
              </a>
            ))}
